...
void PoczatekInterakcji()
{
	...
	multi_reciv = new multicast_net("224.10.104.210", 10001);      // obiekt do odbioru ramek sieciowych
	multi_send = new multicast_net("224.10.104.210", 10001);       // obiekt do wysy³ania ramek
	...
	int       nCmdShow)
{
	...
	okno = CreateWindow(nazwa_klasy, "WZR 2022/23, temat 4, wersja b ", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
